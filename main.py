...
class App(customtkinter.CTk):
    ...
    # textbox main section # indent de tao chapter, rut gon code
        ...
        self.textbox_raw_bounding_box.grid(row=0, column=1, padx=(20, 0), pady=(20, 0), sticky="nsew")
        ...
        self.textbox_summarized.configure(border_width=2,corner_radius=8,fg_color='transparent',border_color="grey",scrollbar_button_hover_color="green")
    ...
    # create scrollable frame
        ...
        self.scrollable_frame_switch_shorten.grid(row=2, column=0, padx=10, pady=(0, 20))
        self.scrollable_frame_switch_summerizer = customtkinter.CTkSwitch(master=self.scrollable_frame, text=f"Summerize")
        self.scrollable_frame_switch_summerizer.grid(row=3, column=0, padx=10, pady=(0, 20))
...
# unused codes
        ...
        # self.entry_tab = customtkinter.CTkFrame(self,corner_radius=4,width=140)
        # self.entry_tab.grid(row=0,column=1,rowspan=2,sticky="nsew")
        # self.entry_tab.grid_rowconfigure(3)
        # self.entry = customtkinter.CTkEntry(self.entry_tab, placeholder_text="enter custom command") #keep maybe
